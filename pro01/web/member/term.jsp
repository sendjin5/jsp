...
<head>
    ...
    <style>
        ...
        .agree.fr {
         width: 900px; margin: 20px auto; border: 1px solid #eee; padding: 20px;
            overflow-y: auto; height: 450px; white-space: pre-wrap;
        }
    </style>
    ...
    <div class="contents" id="contents">
        ...
        <div class="btn_fr">
            ...
            <script>
                ...
                var ck_item1 = document.getElementById("ck_item");
